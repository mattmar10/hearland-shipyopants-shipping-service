...
```bash
heartland-shipyopants-shipping-service$ sam build
```
...
```bash
heartland-shipyopants-shipping-service$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
heartland-shipyopants-shipping-service$ sam local start-api
heartland-shipyopants-shipping-service$ curl http://localhost:3000/
```
...
```bash
heartland-shipyopants-shipping-service$ sam logs -n HelloWorldFunction --stack-name heartland-shipyopants-shipping-service --tail
```
...
```bash
heartland-shipyopants-shipping-service$ cd hello-world
...
```bash
aws cloudformation delete-stack --stack-name heartland-shipyopants-shipping-service
```
